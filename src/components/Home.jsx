...
class Home extends React.Component {
  render() {
    return (
      <div className="home">
        <p>
          <a href="/">HarrisonsBookmarks</a> is a demo app that I completed in
          my demo code along classes for{" "}
        ...
        <p>
          I've also tried to ensure the CSS makes the site mobile friendly as
          well as using <a href="https://sass-lang.com/">SASS</a> for
          preprocessing.
        </p>
      </div>
    );
